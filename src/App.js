...
class App extends Component {
    ...
    onChangeValue = (e) => { //Input값 inputdate에 할당
      let CalendarDate= e.target.value //yyyy-mm-dd
      console.log("onChangeValue, 현재 a(testvalue)값: " + CalendarDate);

      let result1 = CalendarDate.slice(0, 4); //yyyy
      let result2 = CalendarDate.slice(5, 7); //mm
      let result3 = CalendarDate.slice(8, 10); //dd
    ...
    table1 = () => {
        return (
            ...
            <thead> <tr> <th>순위</th> <th>포스터</th ><th>영화명</th> <th>매출액</th> <th>관객수</th > <th>개봉일</th> </tr> </thead>
            <tbody>
        ...
        return (
            <div align='center'>
                ...
                <nav class="nav-extended">
                    ...
                    <a href="#" class="brand-logo center" onClick={this.Reload}><i class="material-icons md-48">local_movies</i>FilmMatch(App.js)</a>
                    </div>
                ...
                {mainBool ? <List date={date} mainBoolHandlerFalse={this.mainBoolHandlerFalse} Div1Invisible={this.Div1Invisible} /> :
                    <div> <hr/> <h4> <i class="material-icons md-36">movie</i> 2023년도 박스오피스 TOP 30 <i class="material-icons md-36">movie</i></h4>
